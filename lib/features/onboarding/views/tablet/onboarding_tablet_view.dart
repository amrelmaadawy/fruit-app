...
class OnboardingTabletView extends StatefulWidget {
  const OnboardingTabletView({super.key});

  @override
  State<OnboardingTabletView> createState() => _OnboardingTabletViewState();
}

class _OnboardingTabletViewState extends State<OnboardingTabletView> {
