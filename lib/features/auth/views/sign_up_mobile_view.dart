              ...
              builder: (context, constraints) {
                ...
                return Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      SizedBox(height: isLandscape ? 10 : (isWeb ? 40 : 5.h)),
                      ...
                      SizedBox(height: isLandscape ? 5 : (isWeb ? 10 : 2.h)),

                      Text(
                        'Welcome to Our app',
                        style: TextStyle(
                          fontSize: isWeb ? 30 : (isLandscape ? 24 : 6.w),
                          fontWeight: FontWeight.bold,
                        ),
                      ),

                      SizedBox(height: isLandscape ? 15 : (isWeb ? 40 : 3.h)),

                      CustomSignInElevationButton(
                        text: 'Sign in with Phone',
                        color: Colors.white,
                        widget: Icon(Icons.phone, size: isWeb ? 22 : (isLandscape ? 20 : 3.sp)),
                        onPressed: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                      ...
                      CustomSignInElevationButton(
                        ...
                        widget: Image.asset(
                          ...
                          width: isWeb ? 22 : (isLandscape ? 20 : 3.w),
                          height: isWeb ? 22 : (isLandscape ? 20 : 3.w),
                        ),
                        onPressed: () {},
                        textColor: const Color(0xff7e7e7e),
                        iconColor: const Color(0xff242729),
                      ...
                      CustomSignInElevationButton(
                        ...
                        widget: Icon(
                          ...
                          color: Colors.white,
                          size: isWeb ? 22 : (isLandscape ? 20 : 3.sp),
                        ),
                        onPressed: () {},
                      ...
                      SizedBox(height: isLandscape ? 15 : (isWeb ? 30 : 3.h)),
                      ...
                      Row(
                        ...
                        children: [
                          Text(
                            'Already member?',
                            style: TextStyle(fontSize: isWeb ? 18 : (isLandscape ? 16 : 4.sp)),
                          ),
                      ...
                      Text(
                        ...
                        style: TextStyle(
                          fontSize: isWeb ? 16 : (isLandscape ? 14 : 4.sp),
                        ),
                      ),

                      SizedBox(height: isLandscape ? 15 : (isWeb ? 40 : 5.h)),
                    ],
                  ),
                );
              },
