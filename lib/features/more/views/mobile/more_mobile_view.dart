...
class MoreMobileView extends StatefulWidget {
  const MoreMobileView({super.key});

  @override
  State<MoreMobileView> createState() => _MoreMobileViewState();
}

class _MoreMobileViewState extends State<MoreMobileView> {
