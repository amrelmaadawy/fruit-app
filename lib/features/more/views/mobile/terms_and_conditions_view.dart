...
class TermsAndConditionsMobileView extends StatelessWidget {
  const TermsAndConditionsMobileView({super.key});
...
a legal contractbetween you (the company) and the user. 
It’s where you 
...
an End User Services Agreement (EUSA).''', style: TextStyle(fontSize: 3.5.sp)),
            ],
          ),
        ),
      ),
